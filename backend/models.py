...
class User_Info(db.Model):
    ...
    ticket=db.relationship("Ticket",cascade="all,delete",backref="user_info",lazy=True)#user can access all of his tickets
...
class Show(db.Model):
    ...
    tickets=db.relationship("Ticket",cascade="all,delete",backref="show",lazy=True)#show can access all of his tickets
